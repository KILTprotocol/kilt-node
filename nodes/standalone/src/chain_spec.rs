		...
		move || {
			devnet_genesis(
				...
				vec![
					...
					get_account_id_from_secret::<ed25519::Public>("//Alice"),
					get_account_id_from_secret::<sr25519::Public>("//Alice//core"),
					get_account_id_from_secret::<sr25519::Public>("//Alice//workshop"),
					get_account_id_from_secret::<sr25519::Public>("//Alice//dapp"),
					get_account_id_from_secret::<sr25519::Public>("//Alice//staking"),
