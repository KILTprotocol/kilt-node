...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn claim(n: u32, ) -> Weight {
		Weight::from_ref_time(57_776_000 as u64)
			// Standard Error: 3_000
			.saturating_add(Weight::from_ref_time(33_000 as u64).saturating_mul(n as u64))
	...
	/// The range of component `n` is `[3, 32]`.
	fn ban(n: u32, ) -> Weight {
		Weight::from_ref_time(56_761_000 as u64)
	...
	/// The range of component `n` is `[3, 32]`.
	fn unban(n: u32, ) -> Weight {
		Weight::from_ref_time(30_863_000 as u64)
			// Standard Error: 1_000
