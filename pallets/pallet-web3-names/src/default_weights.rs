...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	/// The range of component `n` is `[3, 32]`.
	fn reclaim_deposit(n: u32, ) -> Weight {
		Weight::from_ref_time(66_014_688 as u64)
			// Standard Error: 138_142
			.saturating_add(Weight::from_ref_time(6_118 as u64).saturating_mul(n as u64))
	...
	fn change_deposit_owner() -> Weight {
		Weight::from_ref_time(67_804_000 as u64)
			.saturating_add(T::DbWeight::get().reads(4 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: Web3Names Owner (r:1 w:1)
	// Storage: System Account (r:1 w:1)
	fn update_deposit() -> Weight {
		Weight::from_ref_time(59_442_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
