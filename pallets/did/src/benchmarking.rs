...
// pub fn get_did_identifier_from_sr25519_key<T: Config>(public_key: sr25519::Public) -> DidIdentifierOf<T> {
...
// pub fn get_did_identifier_from_ecdsa_key<T: Config>(public_key: ecdsa::Public) -> DidIdentifierOf<T> {
// 	MultiSigner::from(public_key).into_account()
// }
