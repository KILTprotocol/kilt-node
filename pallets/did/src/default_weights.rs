...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	fn add() -> Weight {
		(84_219_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	fn remove() -> Weight {
		(62_689_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
}
...
impl WeightInfo for () {
	fn add() -> Weight {
		(84_219_000 as Weight).saturating_add(RocksDbWeight::get().writes(1 as Weight))
	}
	fn remove() -> Weight {
		(62_689_000 as Weight).saturating_add(RocksDbWeight::get().writes(1 as Weight))
	}
}
