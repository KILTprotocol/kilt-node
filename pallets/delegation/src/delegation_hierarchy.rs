...
/// The result that the delegation pallet expects from the implementer of the delegate's signature verification operation.
...
/// Trait to implement to provide to the delegation pallet signature verification over a delegation details.
pub trait VerifyDelegateSignature {
	...
	/// Verifies that the signature matches the payload and has been generated by the delegate.
	fn verify(
