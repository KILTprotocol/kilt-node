...
//! DATE: 2021-07-13, STEPS: {{cmd.steps}}\, REPEAT: {{cmd.repeat}}\, LOW RANGE: {{cmd.lowest_range_values}}\, HIGH RANGE: {{cmd.highest_range_values}}\
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn revoke_delegation_root_child(r: u32, c: u32, ) -> Weight {
		(11_077_000_u64)
			...
			.saturating_add((17_545_000_u64).saturating_mul(r as Weight))
			// Standard Error: 35_000
			.saturating_add((82_000_u64).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(r as Weight)))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(r as Weight)))
	}
	fn revoke_delegation_leaf(_r: u32, c: u32, ) -> Weight {
		(30_265_000_u64)
			...
			.saturating_add((5_076_000_u64).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(1_u64))
