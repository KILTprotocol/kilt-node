...
// use crate::{
// 	mock::{
// 		events, five_collators_five_nominators, five_collators_no_nominators,
// last_event, one_collator_two_nominators, 		roll_to, set_author,
// two_collators_four_nominators, Balances, Event as MetaEvent, Origin, Stake,
// System, Test, 	},
...
// 	two_collators_four_nominators().execute_with(|| {
// 		roll_to(4);
// 		assert_noop!(Stake::go_offline(Origin::signed(3)),
// Error::<Test>::CandidateDNE); 		roll_to(11);
// 		assert_noop!(Stake::go_online(Origin::signed(3)),
// Error::<Test>::CandidateDNE); 		assert_noop!(Stake::go_online(Origin::
// signed(2)), Error::<Test>::AlreadyActive); 		assert_ok!(Stake::
// go_offline(Origin::signed(2))); 		assert_eq!(last_event(),
// MetaEvent::stake(Event::CollatorWentOffline(3, 2))); 		roll_to(21);
...
// 		assert_noop!(Stake::go_offline(Origin::signed(2)),
// Error::<Test>::AlreadyOffline); 		assert_ok!(Stake::go_online(Origin::
// signed(2))); 		assert_eq!(last_event(),
// MetaEvent::stake(Event::CollatorBackOnline(5, 2))); 		expected.push(Event::
// CollatorBackOnline(5, 2)); 		roll_to(26);
...
// 	two_collators_four_nominators().execute_with(|| {
// 		roll_to(4);
// 		assert_noop!(Stake::leave_candidates(Origin::signed(3)),
// Error::<Test>::CandidateDNE); 		roll_to(11);
// 		assert_ok!(Stake::leave_candidates(Origin::signed(2)));
// 		assert_eq!(last_event(), MetaEvent::stake(Event::CollatorScheduledExit(3, 2,
// 5))); 		let info = Stake::collator_state(&2).unwrap();
...
// 		assert_eq!(last_event(), MetaEvent::stake(Event::CollatorScheduledExit(2, 6,
// 4))); 		roll_to(21);
...
// 		assert_eq!(last_event(), MetaEvent::stake(Event::CollatorScheduledExit(3, 5,
// 5))); 		roll_to(16);
// 		assert_ok!(Stake::leave_candidates(Origin::signed(4)));
// 		assert_eq!(last_event(), MetaEvent::stake(Event::CollatorScheduledExit(4, 4,
// 6))); 		assert_noop!(
...
// 		let mut expected = vec![Event::CollatorChosen(2, 1, 40), Event::NewRound(5,
// 2, 1, 40)]; 		assert_eq!(events(), expected);
...
// 		assert_eq!(events(), expected);
// 		assert_ok!(Stake::leave_candidates(Origin::signed(2)));
// 		assert_eq!(last_event(), MetaEvent::stake(Event::CollatorScheduledExit(6, 2,
// 8))); 		roll_to(31);
// 		let mut new3 = vec![
...
// 			Error::<Test>::NominationDNE
// 		);
// 		assert_noop!(Stake::leave_nominators(Origin::signed(1)),
// Error::<Test>::NominatorDNE); 		assert_ok!(Stake::nominate(Origin::signed(6),
// 2, 3)); 		assert_ok!(Stake::nominate(Origin::signed(6), 3, 3));
...
// 		assert_noop!(Stake::leave_nominators(Origin::signed(66)),
// Error::<Test>::NominatorDNE); 		assert_ok!(Stake::leave_nominators(Origin::
// signed(6))); 		roll_to(21);
...
// 		roll_to(8);
// 		// chooses top TotalSelectedCandidates (5), in order
// 		let init = vec![Event::CollatorChosen(2, 1, 40), Event::NewRound(5, 2, 1,
// 40)]; 		assert_eq!(events(), init);
// 		assert_ok!(Stake::set_blocks_per_round(Origin::root(), 3u32));
// 		assert_eq!(last_event(), MetaEvent::stake(Event::BlocksPerRoundSet(2, 5, 5,
// 3))); 		roll_to(9);
