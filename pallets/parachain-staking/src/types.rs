...
#[derive(Default, Clone, Encode, Decode, RuntimeDebug, PartialEq, Eq, MaxEncodedLen, TypeInfo)]
...
#[derive(Encode, Decode, RuntimeDebug, PartialEq, MaxEncodedLen, TypeInfo)]
...
#[derive(Default, Clone, Encode, Decode, RuntimeDebug, PartialEq, MaxEncodedLen, TypeInfo)]
