...
//! DATE: 2021-10-19, STEPS: {{cmd.steps}}\, REPEAT: {{cmd.repeat}}\, LOW RANGE: {{cmd.lowest_range_values}}\, HIGH RANGE: {{cmd.highest_range_values}}\
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn force_unlock(n: u32, ) -> Weight {
		(29_089_000_u64)
			...
			.saturating_add((29_656_000_u64).saturating_mul(n as Weight))
	...
	fn migrate_multiple_genesis_accounts_vesting(n: u32, ) -> Weight {
		(53_026_000_u64)
			...
			.saturating_add((100_795_000_u64).saturating_mul(n as Weight))
	...
	fn migrate_multiple_genesis_accounts_locking(n: u32, ) -> Weight {
		(62_419_000_u64)
			...
			.saturating_add((102_529_000_u64).saturating_mul(n as Weight))
