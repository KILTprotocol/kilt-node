...
pub(super) const DESTINATION_ACCOUNT: AccountId32 = AccountId32::new([100; 32]);
#[derive(Debug, Clone)]
pub(super) struct ToDestinationAccount;

impl Get<AccountId32> for ToDestinationAccount {
	fn get() -> AccountId32 {
		DESTINATION_ACCOUNT
	}
}
