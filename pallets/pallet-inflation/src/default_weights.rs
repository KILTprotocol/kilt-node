...
//! DATE: 2022-11-22, STEPS: {{cmd.steps}}\, REPEAT: {{cmd.repeat}}\, LOW RANGE: {{cmd.lowest_range_values}}\, HIGH RANGE: {{cmd.highest_range_values}}\
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn on_initialize_mint_to_treasury() -> Weight {
		Weight::from_ref_time(759_793_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	fn on_initialize_no_action() -> Weight {
		Weight::from_ref_time(3_309_000 as u64)
	}
}
