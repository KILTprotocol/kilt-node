...
//! DATE: 2023-02-08, STEPS: {{cmd.steps}}\, REPEAT: {{cmd.repeat}}\, LOW RANGE: {{cmd.lowest_range_values}}\, HIGH RANGE: {{cmd.highest_range_values}}\
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn migrate(n: u32, ) -> Weight {
		Weight::from_ref_time(57_110_726 as u64)
			// Standard Error: 15_796
			.saturating_add(Weight::from_ref_time(11_542_993 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
