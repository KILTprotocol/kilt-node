...
docker run -v $PWD:/data/spec parity/rococo:rococo-v1 build-spec --chain /data/spec/rococo.json --raw --disable-default-bootnode > dev-specs/kilt-parachain/peregrine-relay.json
