...
cargo run --release -p kilt-parachain --features fast-gov -- build-spec --chain staging --disable-default-bootnode >/tmp/parachain/kilt-stage.plain.json
...
cargo run --release -p kilt-parachain --features fast-gov -- build-spec --chain /tmp/parachain/kilt-stage.json --disable-default-bootnode >dev-specs/kilt-parachain/kilt-stage.json
