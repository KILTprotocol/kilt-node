...
pub fn development_config() -> ChainSpec {
	ChainSpec::from_genesis("KILT Development", "kilt-development", development_config_genesis, vec![], None, None, None)
}
...
pub fn local_testnet_config() -> ChainSpec {
	ChainSpec::from_genesis("KILT Local Testnet", "kilt-local_testnet", local_testnet_genesis, vec![], None, None, None)
}
