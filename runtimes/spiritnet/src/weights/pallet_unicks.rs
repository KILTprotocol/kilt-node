...
//! Autogenerated weights for pallet_unicks
//!
...
// --heap-pages=4096
// --output=./runtimes/spiritnet/src/weights/pallet_unicks.rs
...
/// Weight functions for `pallet_unicks`.
...
impl<T: frame_system::Config> pallet_unicks::WeightInfo for WeightInfo<T> {
	...
	fn claim(n: u32, ) -> Weight {
		(54_028_000 as Weight)
			...
			.saturating_add((30_000 as Weight).saturating_mul(n as Weight))
