...
impl<T: frame_system::Config> pallet_token_gateway::WeightInfo for WeightInfo<T> {
	...
	fn create_erc6160_asset(x: u32, ) -> Weight {
		...
		//  Measured:  `290`
		//  Estimated: `3755`
		// Minimum execution time: 61_909_000 picoseconds.
		Weight::from_parts(62_205_309, 0)
			.saturating_add(Weight::from_parts(0, 3755))
			// Standard Error: 11_552
			.saturating_add(Weight::from_parts(2_587_551, 0).saturating_mul(x.into()))
	...
	fn teleport() -> Weight {
		...
		Weight::from_parts(129_290_000, 0)
	...
	fn set_token_gateway_addresses(x: u32, ) -> Weight {
		...
		Weight::from_parts(9_558_682, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 161
			.saturating_add(Weight::from_parts(177, 0).saturating_mul(x.into()))
	...
	fn update_asset_precision(x: u32, ) -> Weight {
		...
		Weight::from_parts(8_794_946, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 2_504
			.saturating_add(Weight::from_parts(2_521_203, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(x.into())))
	}
}
