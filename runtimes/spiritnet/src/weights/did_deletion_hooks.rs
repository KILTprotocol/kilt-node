...
/// Weight functions needed for did_deletion_hooks.
...
impl<T: frame_system::Config> WeightInfo for WeightsInfo<T> {
	...
	fn read_web3_name() -> Weight {
		...
		//  Measured:  `42`
		//  Estimated: `3546`
		// Minimum execution time: 59_664_000 picoseconds.
		Weight::from_parts(61_186_000, 0)
	...
	fn read_web3_account() -> Weight {
		...
		Weight::from_parts(102_081_000, 0)
	...
	fn read_dot_account() -> Weight {
		...
		Weight::from_parts(149_073_000, 0)
			.saturating_add(Weight::from_parts(0, 3562))
			.saturating_add(T::DbWeight::get().reads(1))
	}
}
