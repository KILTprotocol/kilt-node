...
impl<T: frame_system::Config> kilt_launch::WeightInfo for WeightInfo<T> {
	...
	fn force_unlock(n: u32, ) -> Weight {
		(45_480_000_u64)
			...
			.saturating_add((64_881_000_u64).saturating_mul(n as Weight))
	...
	fn migrate_multiple_genesis_accounts_vesting(n: u32, ) -> Weight {
		(98_507_000_u64)
			...
			.saturating_add((222_583_000_u64).saturating_mul(n as Weight))
	...
	fn migrate_multiple_genesis_accounts_locking(n: u32, ) -> Weight {
		(105_992_000_u64)
			...
			.saturating_add((226_856_000_u64).saturating_mul(n as Weight))
