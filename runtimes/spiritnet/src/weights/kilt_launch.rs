...
impl<T: frame_system::Config> kilt_launch::WeightInfo for WeightInfo<T> {
	...
	fn force_unlock(n: u32, ) -> Weight {
		(29_383_000_u64)
			...
			.saturating_add((28_315_000_u64).saturating_mul(n as Weight))
	...
	fn migrate_multiple_genesis_accounts_vesting(n: u32, ) -> Weight {
		(45_217_000_u64)
			...
			.saturating_add((96_775_000_u64).saturating_mul(n as Weight))
	...
	fn migrate_multiple_genesis_accounts_locking(n: u32, ) -> Weight {
		(60_129_000_u64)
			...
			.saturating_add((98_154_000_u64).saturating_mul(n as Weight))
