...
impl<T: frame_system::Config> attestation::WeightInfo for WeightInfo<T> {
	...
	fn add() -> Weight {
		Weight::from_ref_time(113_413_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: Attestation Attestations (r:1 w:1)
	fn revoke() -> Weight {
		Weight::from_ref_time(63_635_000 as u64)
	...
	// Storage: System Account (r:1 w:1)
	fn remove() -> Weight {
		Weight::from_ref_time(106_138_000 as u64)
	...
	fn reclaim_deposit() -> Weight {
		Weight::from_ref_time(49_698_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: Attestation Attestations (r:1 w:1)
	...
	fn change_deposit_owner() -> Weight {
		Weight::from_ref_time(65_336_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
	...
	fn update_deposit() -> Weight {
		Weight::from_ref_time(59_916_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
}
