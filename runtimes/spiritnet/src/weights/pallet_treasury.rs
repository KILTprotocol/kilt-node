...
impl<T: frame_system::Config> pallet_treasury::WeightInfo for WeightInfo<T> {
	fn spend() -> Weight {
		Weight::from_ref_time(334_000 as u64)
	}
	...
	fn reject_proposal() -> Weight {
		Weight::from_ref_time(67_363_000 as u64)
	...
	fn approve_proposal(p: u32, ) -> Weight {
		Weight::from_ref_time(22_539_000 as u64)
			// Standard Error: 1_000
			.saturating_add(Weight::from_ref_time(195_000 as u64).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Treasury Approvals (r:1 w:1)
	fn remove_approval() -> Weight {
		Weight::from_ref_time(15_450_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	...
	fn on_initialize_proposals(p: u32, ) -> Weight {
		Weight::from_ref_time(83_774_000 as u64)
			// Standard Error: 20_000
			.saturating_add(Weight::from_ref_time(42_721_000 as u64).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
