...
impl<T: frame_system::Config> pallet_treasury::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize_proposals(_p: u32, ) -> Weight {
		(4_715_406_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(302 as Weight))
			.saturating_add(T::DbWeight::get().writes(302 as Weight))
	}
}
