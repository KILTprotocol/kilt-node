...
impl<T: frame_system::Config> pallet_collective::WeightInfo for WeightInfo<T> {
	...
	fn set_members(m: u32, _n: u32, p: u32, ) -> Weight {
		Weight::from_ref_time(0 as u64)
			...
			.saturating_add(Weight::from_ref_time(12_098_000 as u64).saturating_mul(m as u64))
			// Standard Error: 9_000
			.saturating_add(Weight::from_ref_time(15_976_000 as u64).saturating_mul(p as u64))
	...
	fn propose_execute(b: u32, m: u32, ) -> Weight {
		Weight::from_ref_time(36_491_000 as u64)
			// Standard Error: 0
			.saturating_add(Weight::from_ref_time(2_000 as u64).saturating_mul(b as u64))
			// Standard Error: 0
	...
	fn vote(m: u32, ) -> Weight {
		Weight::from_ref_time(50_868_000 as u64)
	...
	fn close_early_disapproved(m: u32, p: u32, ) -> Weight {
		Weight::from_ref_time(51_004_000 as u64)
			// Standard Error: 1_000
			.saturating_add(Weight::from_ref_time(27_000 as u64).saturating_mul(m as u64))
			// Standard Error: 1_000
			.saturating_add(Weight::from_ref_time(225_000 as u64).saturating_mul(p as u64))
	...
	fn close_early_approved(b: u32, m: u32, p: u32, ) -> Weight {
		Weight::from_ref_time(61_855_000 as u64)
			// Standard Error: 0
			...
			// Standard Error: 1_000
			.saturating_add(Weight::from_ref_time(243_000 as u64).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(4 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: Council Voting (r:1 w:1)
	...
	fn close_approved(b: u32, m: u32, p: u32, ) -> Weight {
		Weight::from_ref_time(68_549_000 as u64)
			// Standard Error: 0
			.saturating_add(Weight::from_ref_time(2_000 as u64).saturating_mul(b as u64))
			// Standard Error: 1_000
	...
	fn disapprove_proposal(p: u32, ) -> Weight {
		Weight::from_ref_time(35_482_000 as u64)
			// Standard Error: 1_000
