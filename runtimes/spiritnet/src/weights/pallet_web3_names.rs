...
impl<T: frame_system::Config> pallet_web3_names::WeightInfo for WeightInfo<T> {
	...
	fn claim(n: u32, ) -> Weight {
		Weight::from_ref_time(58_659_000 as u64)
	...
	fn reclaim_deposit(n: u32, ) -> Weight {
		Weight::from_ref_time(52_610_000 as u64)
	...
	fn ban(n: u32, ) -> Weight {
		Weight::from_ref_time(57_243_000 as u64)
			// Standard Error: 1_000
			.saturating_add(Weight::from_ref_time(49_000 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
	...
	fn unban(n: u32, ) -> Weight {
		Weight::from_ref_time(31_489_000 as u64)
			// Standard Error: 1_000
			.saturating_add(Weight::from_ref_time(46_000 as u64).saturating_mul(n as u64))
