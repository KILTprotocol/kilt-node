...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn set_storage(i: u32, ) -> Weight {
		(0_u64)
			...
			.saturating_add((1_315_000_u64).saturating_mul(i as Weight))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i as Weight)))
	}
	fn kill_storage(i: u32, ) -> Weight {
		(0_u64)
			// Standard Error: 1_000
			.saturating_add((1_034_000_u64).saturating_mul(i as Weight))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i as Weight)))
	}
	fn kill_prefix(p: u32, ) -> Weight {
		(3_763_000_u64)
			// Standard Error: 3_000
			.saturating_add((1_821_000_u64).saturating_mul(p as Weight))
