...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(10_371_000, 0)
			...
			.saturating_add(Weight::from_parts(4_205_745, 0).saturating_mul(c.into()))
	}
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_parts(10_239_000, 0)
			...
			.saturating_add(Weight::from_parts(4_505_009, 0).saturating_mul(c.into()))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(10_365_000, 0)
			...
			.saturating_add(Weight::from_parts(4_184_770, 0).saturating_mul(c.into()))
	}
}
