...
impl<T: frame_system::Config> delegation::WeightInfo for WeightInfo<T> {
	...
	fn revoke_delegation_root_child(r: u32, c: u32, ) -> Weight {
		(20_242_000 as Weight)
			...
			.saturating_add((17_467_000 as Weight).saturating_mul(r as Weight))
			// Standard Error: 52_000
	...
	fn revoke_delegation_leaf(_r: u32, c: u32, ) -> Weight {
		(38_384_000 as Weight)
			...
			.saturating_add((5_370_000 as Weight).saturating_mul(c as Weight))
	...
	fn remove_delegation(r: u32, ) -> Weight {
		(62_215_000 as Weight)
			...
			.saturating_add((31_974_000 as Weight).saturating_mul(r as Weight))
			.saturating_add(T::DbWeight::get().reads(3 as Weight))
			.saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(r as Weight)))
			.saturating_add(T::DbWeight::get().writes(3 as Weight))
			.saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(r as Weight)))
	...
	fn reclaim_deposit(r: u32, ) -> Weight {
		(53_556_000 as Weight)
			// Standard Error: 76_000
			.saturating_add((31_906_000 as Weight).saturating_mul(r as Weight))
			.saturating_add(T::DbWeight::get().reads(2 as Weight))
			.saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(r as Weight)))
			.saturating_add(T::DbWeight::get().writes(3 as Weight))
			.saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(r as Weight)))
	...
	fn can_revoke(c: u32, ) -> Weight {
		(8_605_000 as Weight)
			// Standard Error: 18_000
			.saturating_add((5_452_000 as Weight).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
			.saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(c as Weight)))
	}
	// Storage: Delegation DelegationNodes (r:2 w:0)
	fn can_remove(c: u32, ) -> Weight {
		(8_663_000 as Weight)
			...
			.saturating_add((5_427_000 as Weight).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
			.saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(c as Weight)))
	}
}
