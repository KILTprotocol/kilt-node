...
impl<T: frame_system::Config> delegation::WeightInfo for WeightInfo<T> {
	...
	fn create_hierarchy() -> Weight {
		Weight::from_ref_time(58_121_000 as u64)
	...
	fn add_delegation() -> Weight {
		Weight::from_ref_time(64_134_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	...
	fn revoke_delegation_root_child(r: u32, c: u32, ) -> Weight {
		Weight::from_ref_time(34_233_000 as u64)
			// Standard Error: 40_000
			.saturating_add(Weight::from_ref_time(13_991_000 as u64).saturating_mul(r as u64))
			// Standard Error: 40_000
			.saturating_add(Weight::from_ref_time(341_000 as u64).saturating_mul(c as u64))
	...
	fn revoke_delegation_leaf(r: u32, c: u32, ) -> Weight {
		Weight::from_ref_time(49_062_000 as u64)
			// Standard Error: 10_000
			.saturating_add(Weight::from_ref_time(56_000 as u64).saturating_mul(r as u64))
			// Standard Error: 10_000
			.saturating_add(Weight::from_ref_time(4_113_000 as u64).saturating_mul(c as u64))
	...
	fn remove_delegation(r: u32, ) -> Weight {
		Weight::from_ref_time(70_044_000 as u64)
			// Standard Error: 16_000
			.saturating_add(Weight::from_ref_time(24_079_000 as u64).saturating_mul(r as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(r as u64)))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(r as u64)))
	...
	fn reclaim_deposit(r: u32, ) -> Weight {
		Weight::from_ref_time(62_299_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(24_288_000 as u64).saturating_mul(r as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(r as u64)))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(r as u64)))
	...
	fn can_revoke(c: u32, ) -> Weight {
		Weight::from_ref_time(13_473_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(4_511_000 as u64).saturating_mul(c as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(c as u64)))
	}
	// Storage: Delegation DelegationNodes (r:2 w:0)
	fn can_remove(c: u32, ) -> Weight {
		Weight::from_ref_time(13_172_000 as u64)
			// Standard Error: 9_000
			.saturating_add(Weight::from_ref_time(4_545_000 as u64).saturating_mul(c as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(c as u64)))
	}
	// Storage: Delegation DelegationNodes (r:1 w:1)
	...
	fn change_deposit_owner() -> Weight {
		Weight::from_ref_time(69_711_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: Delegation DelegationNodes (r:1 w:1)
	...
	fn update_deposit() -> Weight {
		Weight::from_ref_time(65_252_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
