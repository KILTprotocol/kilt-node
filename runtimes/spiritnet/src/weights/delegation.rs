...
impl<T: frame_system::Config> delegation::WeightInfo for WeightInfo<T> {
	...
	fn create_hierarchy() -> Weight {
		Weight::from_ref_time(53_955_000 as u64)
	...
	fn add_delegation() -> Weight {
		Weight::from_ref_time(61_850_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	...
	fn revoke_delegation_root_child(r: u32, c: u32, ) -> Weight {
		Weight::from_ref_time(31_115_405 as u64)
			// Standard Error: 30_720
			.saturating_add(Weight::from_ref_time(13_681_259 as u64).saturating_mul(r as u64))
			// Standard Error: 30_720
			.saturating_add(Weight::from_ref_time(396_279 as u64).saturating_mul(c as u64))
	...
	fn revoke_delegation_leaf(r: u32, c: u32, ) -> Weight {
		Weight::from_ref_time(46_244_808 as u64)
			// Standard Error: 8_057
			.saturating_add(Weight::from_ref_time(22_264 as u64).saturating_mul(r as u64))
			// Standard Error: 8_057
			.saturating_add(Weight::from_ref_time(3_976_044 as u64).saturating_mul(c as u64))
	...
	fn remove_delegation(r: u32, ) -> Weight {
		Weight::from_ref_time(65_760_986 as u64)
			// Standard Error: 20_055
			.saturating_add(Weight::from_ref_time(23_871_683 as u64).saturating_mul(r as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(r as u64)))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(r as u64)))
	...
	fn reclaim_deposit(r: u32, ) -> Weight {
		Weight::from_ref_time(59_248_538 as u64)
			// Standard Error: 16_962
			.saturating_add(Weight::from_ref_time(23_652_265 as u64).saturating_mul(r as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(r as u64)))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(r as u64)))
	...
	fn can_attest() -> Weight {
		Weight::from_ref_time(17_226_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
	}
	// Storage: Delegation DelegationNodes (r:2 w:0)
	fn can_revoke(c: u32, ) -> Weight {
		Weight::from_ref_time(12_042_795 as u64)
			// Standard Error: 8_505
			.saturating_add(Weight::from_ref_time(4_259_487 as u64).saturating_mul(c as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(c as u64)))
	}
	// Storage: Delegation DelegationNodes (r:2 w:0)
	fn can_remove(c: u32, ) -> Weight {
		Weight::from_ref_time(11_945_314 as u64)
			// Standard Error: 8_509
			.saturating_add(Weight::from_ref_time(4_297_118 as u64).saturating_mul(c as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(c as u64)))
	}
	// Storage: Delegation DelegationNodes (r:1 w:1)
	...
	fn update_deposit() -> Weight {
		Weight::from_ref_time(63_911_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
