...
impl<T: frame_system::Config> delegation::WeightInfo for WeightInfo<T> {
	...
	fn create_hierarchy() -> Weight {
		Weight::from_ref_time(43_036_000 as u64)
	...
	fn add_delegation() -> Weight {
		Weight::from_ref_time(48_689_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	...
	fn revoke_delegation_root_child(r: u32, c: u32, ) -> Weight {
		Weight::from_ref_time(25_053_090 as u64)
			// Standard Error: 27_573
			.saturating_add(Weight::from_ref_time(10_221_730 as u64).saturating_mul(r as u64))
			// Standard Error: 27_573
			.saturating_add(Weight::from_ref_time(263_133 as u64).saturating_mul(c as u64))
	...
	fn revoke_delegation_leaf(r: u32, c: u32, ) -> Weight {
		Weight::from_ref_time(36_207_689 as u64)
			// Standard Error: 8_282
			.saturating_add(Weight::from_ref_time(18_368 as u64).saturating_mul(r as u64))
			// Standard Error: 8_282
			.saturating_add(Weight::from_ref_time(3_277_799 as u64).saturating_mul(c as u64))
	...
	fn remove_delegation(r: u32, ) -> Weight {
		Weight::from_ref_time(52_510_612 as u64)
			// Standard Error: 18_891
			.saturating_add(Weight::from_ref_time(17_415_111 as u64).saturating_mul(r as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(r as u64)))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(r as u64)))
	...
	fn reclaim_deposit(r: u32, ) -> Weight {
		Weight::from_ref_time(47_206_849 as u64)
			// Standard Error: 15_798
			.saturating_add(Weight::from_ref_time(17_332_535 as u64).saturating_mul(r as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(r as u64)))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(r as u64)))
	...
	fn can_revoke(c: u32, ) -> Weight {
		Weight::from_ref_time(9_469_811 as u64)
			// Standard Error: 9_421
			.saturating_add(Weight::from_ref_time(3_531_320 as u64).saturating_mul(c as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(c as u64)))
	}
	// Storage: Delegation DelegationNodes (r:2 w:0)
	fn can_remove(c: u32, ) -> Weight {
		Weight::from_ref_time(9_509_767 as u64)
			// Standard Error: 8_183
			.saturating_add(Weight::from_ref_time(3_516_001 as u64).saturating_mul(c as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(c as u64)))
	}
	// Storage: Delegation DelegationNodes (r:1 w:1)
	...
	fn update_deposit() -> Weight {
		Weight::from_ref_time(48_922_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
