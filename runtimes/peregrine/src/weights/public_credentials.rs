...
impl<T: frame_system::Config> public_credentials::WeightInfo for WeightInfo<T> {
	...
	fn add(c: u32, ) -> Weight {
		Weight::from_ref_time(95_650_839 as u64)
			// Standard Error: 48
			.saturating_add(Weight::from_ref_time(2_632 as u64).saturating_mul(c as u64))
	...
	// Storage: PublicCredentials Credentials (r:1 w:1)
	fn revoke() -> Weight {
		Weight::from_ref_time(86_537_000 as u64)
	...
	// Storage: PublicCredentials Credentials (r:1 w:1)
	fn unrevoke() -> Weight {
		Weight::from_ref_time(42_505_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	...
	// Storage: System Account (r:1 w:1)
	fn remove() -> Weight {
		Weight::from_ref_time(66_501_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: PublicCredentials CredentialSubjects (r:1 w:1)
	...
	fn reclaim_deposit() -> Weight {
		Weight::from_ref_time(65_748_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: PublicCredentials CredentialSubjects (r:1 w:0)
	...
	fn change_deposit_owner() -> Weight {
		Weight::from_ref_time(85_655_000 as u64)
	...
	fn update_deposit() -> Weight {
		Weight::from_ref_time(79_903_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
