...
impl<T: frame_system::Config> pallet_token_gateway::WeightInfo for WeightInfo<T> {
	...
	/// Storage: UNKNOWN KEY `0x52657175657374436f6d6d69746d656e747333c2095ada582ac4c1499d9d6092` (r:1 w:1)
	/// Proof: UNKNOWN KEY `0x52657175657374436f6d6d69746d656e747333c2095ada582ac4c1499d9d6092` (r:1 w:1)
	/// Storage: UNKNOWN KEY `0x526571756573745061796d656e7433c2095ada582ac4c1499d9d6092243ea5b3` (r:0 w:1)
	/// Proof: UNKNOWN KEY `0x526571756573745061796d656e7433c2095ada582ac4c1499d9d6092243ea5b3` (r:0 w:1)
	/// The range of component `x` is `[1, 100]`.
	fn create_erc6160_asset(x: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `290`
		//  Estimated: `3755`
		// Minimum execution time: 60_149_000 picoseconds.
		Weight::from_parts(61_529_136, 0)
			.saturating_add(Weight::from_parts(0, 3755))
			// Standard Error: 2_181
			.saturating_add(Weight::from_parts(2_468_539, 0).saturating_mul(x.into()))
	...
	/// Storage: `Ismp::Nonce` (r:1 w:1)
	/// Proof: `Ismp::Nonce` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	/// Storage: UNKNOWN KEY `0x52657175657374436f6d6d69746d656e7473367017d1ad5c23b0cb1956a4350a` (r:1 w:1)
	/// Proof: UNKNOWN KEY `0x52657175657374436f6d6d69746d656e7473367017d1ad5c23b0cb1956a4350a` (r:1 w:1)
	/// Storage: UNKNOWN KEY `0x526571756573745061796d656e74367017d1ad5c23b0cb1956a4350ab27f1a08` (r:0 w:1)
	/// Proof: UNKNOWN KEY `0x526571756573745061796d656e74367017d1ad5c23b0cb1956a4350ab27f1a08` (r:0 w:1)
	fn teleport() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `846`
		//  Estimated: `4311`
		// Minimum execution time: 126_789_000 picoseconds.
		Weight::from_parts(128_411_000, 0)
	...
	/// Storage: `Ismp::Nonce` (r:1 w:1)
	/// Proof: `Ismp::Nonce` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	/// Storage: UNKNOWN KEY `0x52657175657374436f6d6d69746d656e7473203c0d3cc447f181440596bddf2f` (r:1 w:1)
	/// Proof: UNKNOWN KEY `0x52657175657374436f6d6d69746d656e7473203c0d3cc447f181440596bddf2f` (r:1 w:1)
	/// Storage: UNKNOWN KEY `0x526571756573745061796d656e74203c0d3cc447f181440596bddf2fb5484348` (r:0 w:1)
	/// Proof: UNKNOWN KEY `0x526571756573745061796d656e74203c0d3cc447f181440596bddf2fb5484348` (r:0 w:1)
	...
	fn update_asset_precision(x: u32, ) -> Weight {
		...
		Weight::from_parts(8_975_612, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 1_992
			.saturating_add(Weight::from_parts(2_438_896, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(x.into())))
	}
}
