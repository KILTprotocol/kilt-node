...
impl<T: frame_system::Config> pallet_token_gateway::WeightInfo for WeightInfo<T> {
	...
	fn create_erc6160_asset(x: u32, ) -> Weight {
		...
		Weight::from_parts(30_872_263, 0)
			.saturating_add(Weight::from_parts(0, 3755))
			// Standard Error: 3_317
			.saturating_add(Weight::from_parts(1_558_070, 0).saturating_mul(x.into()))
	...
	fn teleport() -> Weight {
		...
		//  Measured:  `732`
		//  Estimated: `4197`
		// Minimum execution time: 64_709_000 picoseconds.
		Weight::from_parts(66_906_000, 0)
	...
	fn update_asset_precision(x: u32, ) -> Weight {
		...
		Weight::from_parts(2_719_181, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 3_076
			.saturating_add(Weight::from_parts(1_528_011, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(x.into())))
	}
}
