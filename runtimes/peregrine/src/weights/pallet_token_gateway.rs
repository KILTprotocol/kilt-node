...
impl<T: frame_system::Config> pallet_token_gateway::WeightInfo for WeightInfo<T> {
	...
	/// Storage: UNKNOWN KEY `0x52657175657374436f6d6d69746d656e74732d20b63c8e31876e51eb5b9095b0` (r:1 w:1)
	/// Proof: UNKNOWN KEY `0x52657175657374436f6d6d69746d656e74732d20b63c8e31876e51eb5b9095b0` (r:1 w:1)
	/// Storage: UNKNOWN KEY `0x526571756573745061796d656e742d20b63c8e31876e51eb5b9095b0c8fee0ca` (r:0 w:1)
	/// Proof: UNKNOWN KEY `0x526571756573745061796d656e742d20b63c8e31876e51eb5b9095b0c8fee0ca` (r:0 w:1)
	...
	fn create_erc6160_asset(x: u32, ) -> Weight {
		...
		Weight::from_parts(62_083_602, 0)
			.saturating_add(Weight::from_parts(0, 3755))
			// Standard Error: 2_948
			.saturating_add(Weight::from_parts(2_596_761, 0).saturating_mul(x.into()))
	...
	fn teleport() -> Weight {
		...
		//  Measured:  `846`
		//  Estimated: `4311`
		// Minimum execution time: 130_450_000 picoseconds.
		Weight::from_parts(131_632_000, 0)
	...
	fn set_token_gateway_addresses(_x: u32, ) -> Weight {
		...
		Weight::from_parts(10_171_347, 0)
	...
	/// Storage: `Ismp::Nonce` (r:1 w:1)
	/// Proof: `Ismp::Nonce` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	/// Storage: UNKNOWN KEY `0x52657175657374436f6d6d69746d656e74737c12d7b0ef5278a9308b5467aef1` (r:1 w:1)
	/// Proof: UNKNOWN KEY `0x52657175657374436f6d6d69746d656e74737c12d7b0ef5278a9308b5467aef1` (r:1 w:1)
	/// Storage: UNKNOWN KEY `0x526571756573745061796d656e747c12d7b0ef5278a9308b5467aef1f4cecb1f` (r:0 w:1)
	/// Proof: UNKNOWN KEY `0x526571756573745061796d656e747c12d7b0ef5278a9308b5467aef1f4cecb1f` (r:0 w:1)
	fn update_erc6160_asset() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `493`
		//  Estimated: `3958`
		// Minimum execution time: 52_779_000 picoseconds.
		Weight::from_parts(53_622_000, 0)
	...
	fn update_asset_precision(x: u32, ) -> Weight {
		...
		Weight::from_parts(8_560_767, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 2_195
			.saturating_add(Weight::from_parts(2_568_458, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(x.into())))
	}
}
