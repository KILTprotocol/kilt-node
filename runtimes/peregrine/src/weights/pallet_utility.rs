...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(10_696_000, 0)
			...
			.saturating_add(Weight::from_parts(4_637_318, 0).saturating_mul(c.into()))
	}
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_parts(10_762_000, 0)
			...
			.saturating_add(Weight::from_parts(4_954_029, 0).saturating_mul(c.into()))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(10_840_000, 0)
			...
			.saturating_add(Weight::from_parts(4_634_920, 0).saturating_mul(c.into()))
	}
}
