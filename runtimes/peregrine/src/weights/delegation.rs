...
impl<T: frame_system::Config> delegation::WeightInfo for WeightInfo<T> {
	...
	fn create_hierarchy() -> Weight {
		Weight::from_ref_time(42_736_000 as u64)
	...
	fn revoke_delegation_root_child(r: u32, c: u32, ) -> Weight {
		Weight::from_ref_time(24_399_705 as u64)
			// Standard Error: 26_899
			.saturating_add(Weight::from_ref_time(10_016_113 as u64).saturating_mul(r as u64))
			// Standard Error: 26_899
			.saturating_add(Weight::from_ref_time(315_737 as u64).saturating_mul(c as u64))
	...
	fn revoke_delegation_leaf(r: u32, c: u32, ) -> Weight {
		Weight::from_ref_time(35_427_685 as u64)
			// Standard Error: 8_044
			.saturating_add(Weight::from_ref_time(79_049 as u64).saturating_mul(r as u64))
			// Standard Error: 8_044
			.saturating_add(Weight::from_ref_time(3_204_121 as u64).saturating_mul(c as u64))
	...
	fn remove_delegation(r: u32, ) -> Weight {
		Weight::from_ref_time(51_225_149 as u64)
			// Standard Error: 18_378
			.saturating_add(Weight::from_ref_time(16_840_534 as u64).saturating_mul(r as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(r as u64)))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(r as u64)))
	...
	fn reclaim_deposit(r: u32, ) -> Weight {
		Weight::from_ref_time(46_045_661 as u64)
			// Standard Error: 17_110
			.saturating_add(Weight::from_ref_time(16_723_083 as u64).saturating_mul(r as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(r as u64)))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(r as u64)))
	...
	fn can_attest() -> Weight {
		Weight::from_ref_time(13_976_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
	}
	// Storage: Delegation DelegationNodes (r:2 w:0)
	fn can_revoke(c: u32, ) -> Weight {
		Weight::from_ref_time(9_348_516 as u64)
			// Standard Error: 7_898
			.saturating_add(Weight::from_ref_time(3_487_123 as u64).saturating_mul(c as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(c as u64)))
	}
	// Storage: Delegation DelegationNodes (r:2 w:0)
	fn can_remove(c: u32, ) -> Weight {
		Weight::from_ref_time(9_328_157 as u64)
			// Standard Error: 7_455
			.saturating_add(Weight::from_ref_time(3_491_185 as u64).saturating_mul(c as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(c as u64)))
	}
	// Storage: Delegation DelegationNodes (r:1 w:1)
	...
	fn change_deposit_owner() -> Weight {
		Weight::from_ref_time(52_301_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: Delegation DelegationNodes (r:1 w:1)
	...
	fn update_deposit() -> Weight {
		Weight::from_ref_time(48_510_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
