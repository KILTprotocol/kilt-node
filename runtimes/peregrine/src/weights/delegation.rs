...
//! DATE: 2021-07-19, STEPS: `[1, ]`, REPEAT: 20, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> delegation::WeightInfo for WeightInfo<T> {
	...
	fn revoke_hierarchy(r: u32, ) -> Weight {
		(43_886_000_u64)
			...
			.saturating_add((30_900_000_u64).saturating_mul(r as Weight))
	...
	fn revoke_delegation_root_child(r: u32, _c: u32, ) -> Weight {
		(21_840_000_u64)
			...
			.saturating_add((30_669_000_u64).saturating_mul(r as Weight))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(r as Weight)))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(r as Weight)))
	}
	fn revoke_delegation_leaf(r: u32, c: u32, ) -> Weight {
		(52_078_000_u64)
			...
			.saturating_add((228_000_u64).saturating_mul(r as Weight))
			// Standard Error: 193_000
			.saturating_add((7_997_000_u64).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(1_u64))
