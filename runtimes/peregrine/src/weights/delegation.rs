...
//! DATE: 2021-07-21, STEPS: `[1, ]`, REPEAT: 20, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> delegation::WeightInfo for WeightInfo<T> {
	...
	fn revoke_delegation_root_child(r: u32, c: u32, ) -> Weight {
		(24_607_000_u64)
			...
			.saturating_add((30_915_000_u64).saturating_mul(r as Weight))
			// Standard Error: 425_000
			.saturating_add((860_000_u64).saturating_mul(c as Weight))
	...
	fn revoke_delegation_leaf(r: u32, c: u32, ) -> Weight {
		(58_402_000_u64)
			...
			// Standard Error: 307_000
			.saturating_add((8_464_000_u64).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(2_u64))
