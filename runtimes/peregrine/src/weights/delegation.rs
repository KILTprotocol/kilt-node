...
impl<T: frame_system::Config> delegation::WeightInfo for WeightInfo<T> {
	...
	fn revoke_delegation_root_child(r: u32, c: u32, ) -> Weight {
		(20_661_000 as Weight)
			...
			.saturating_add((17_404_000 as Weight).saturating_mul(r as Weight))
			// Standard Error: 55_000
	...
	fn revoke_delegation_leaf(_r: u32, c: u32, ) -> Weight {
		(38_367_000 as Weight)
			...
			.saturating_add((5_464_000 as Weight).saturating_mul(c as Weight))
	...
	fn remove_delegation(r: u32, ) -> Weight {
		(62_337_000 as Weight)
			// Standard Error: 74_000
			.saturating_add((31_937_000 as Weight).saturating_mul(r as Weight))
			.saturating_add(T::DbWeight::get().reads(3 as Weight))
			.saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(r as Weight)))
			.saturating_add(T::DbWeight::get().writes(3 as Weight))
			.saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(r as Weight)))
	...
	fn reclaim_deposit(r: u32, ) -> Weight {
		(53_133_000 as Weight)
			...
			.saturating_add((32_084_000 as Weight).saturating_mul(r as Weight))
			.saturating_add(T::DbWeight::get().reads(2 as Weight))
			.saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(r as Weight)))
			.saturating_add(T::DbWeight::get().writes(3 as Weight))
			.saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(r as Weight)))
	...
	fn can_attest(r: u32, c: u32, ) -> Weight {
		(8_620_000 as Weight)
	...
	// Storage: Delegation DelegationNodes (r:6 w:0)
	fn can_revoke(r: u32, c: u32, ) -> Weight {
		(8_913_000 as Weight)
			// Standard Error: 20_000
			.saturating_add((13_000 as Weight).saturating_mul(r as Weight))
			// Standard Error: 20_000
			.saturating_add((5_351_000 as Weight).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
			.saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(c as Weight)))
	}
	// Storage: Delegation DelegationNodes (r:6 w:0)
	fn can_remove(r: u32, c: u32, ) -> Weight {
		(8_903_000 as Weight)
			// Standard Error: 21_000
			.saturating_add((22_000 as Weight).saturating_mul(r as Weight))
			// Standard Error: 21_000
			.saturating_add((5_356_000 as Weight).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
			.saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(c as Weight)))
	}
}
