...
impl<T: frame_system::Config> pallet_did_lookup::WeightInfo for WeightInfo<T> {
	...
	fn associate_account_multisig_sr25519() -> Weight {
		Weight::from_ref_time(109_033_000 as u64)
	...
	fn associate_account_multisig_ed25519() -> Weight {
		Weight::from_ref_time(107_730_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(4 as u64))
	}
	// Storage: System Account (r:1 w:1)
	...
	fn associate_account_multisig_ecdsa() -> Weight {
		Weight::from_ref_time(98_439_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(4 as u64))
	}
	// Storage: System Account (r:1 w:1)
	...
	fn associate_eth_account() -> Weight {
		Weight::from_ref_time(99_214_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(4 as u64))
	}
	// Storage: System Account (r:1 w:1)
	...
	fn associate_sender() -> Weight {
		Weight::from_ref_time(85_606_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(4 as u64))
	}
	// Storage: DidLookup ConnectedDids (r:1 w:1)
	...
	fn remove_sender_association() -> Weight {
		Weight::from_ref_time(40_244_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
	...
	fn remove_account_association() -> Weight {
		Weight::from_ref_time(60_862_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: DidLookup ConnectedDids (r:1 w:1)
	...
	fn change_deposit_owner() -> Weight {
		Weight::from_ref_time(75_814_000 as u64)
	...
	fn update_deposit() -> Weight {
		Weight::from_ref_time(46_142_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: DidLookup MigrationStateStore (r:1 w:1)
	// Storage: DidLookup ConnectedDids (r:2 w:2)
	// Storage: DidLookup ConnectedAccounts (r:1 w:2)
	fn migrate(n: u32, ) -> Weight {
		Weight::from_ref_time(56_177_232 as u64)
			// Standard Error: 16_362
			.saturating_add(Weight::from_ref_time(11_580_138 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
