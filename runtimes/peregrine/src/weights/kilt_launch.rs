...
impl<T: frame_system::Config> kilt_launch::WeightInfo for WeightInfo<T> {
	...
	fn force_unlock(n: u32, ) -> Weight {
		(26_243_000_u64)
			...
			.saturating_add((27_545_000_u64).saturating_mul(n as Weight))
	...
	fn migrate_multiple_genesis_accounts_vesting(n: u32, ) -> Weight {
		(47_133_000_u64)
			...
			.saturating_add((98_089_000_u64).saturating_mul(n as Weight))
	...
	fn migrate_multiple_genesis_accounts_locking(n: u32, ) -> Weight {
		(60_835_000_u64)
			...
			.saturating_add((95_945_000_u64).saturating_mul(n as Weight))
