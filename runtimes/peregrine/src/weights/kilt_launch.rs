...
impl<T: frame_system::Config> kilt_launch::WeightInfo for WeightInfo<T> {
	...
	fn force_unlock(n: u32, ) -> Weight {
		(28_519_000_u64)
			...
			.saturating_add((30_047_000_u64).saturating_mul(n as Weight))
	...
	fn migrate_multiple_genesis_accounts_vesting(n: u32, ) -> Weight {
		(52_801_000_u64)
			...
			.saturating_add((101_926_000_u64).saturating_mul(n as Weight))
	...
	fn migrate_multiple_genesis_accounts_locking(n: u32, ) -> Weight {
		(61_222_000_u64)
			...
			.saturating_add((103_939_000_u64).saturating_mul(n as Weight))
