...
impl<T: frame_system::Config> kilt_launch::WeightInfo for WeightInfo<T> {
	...
	fn force_unlock(n: u32, ) -> Weight {
		(23_761_000_u64)
			...
			.saturating_add((42_480_000_u64).saturating_mul(n as Weight))
	...
	fn migrate_multiple_genesis_accounts_vesting(n: u32, ) -> Weight {
		(65_896_000_u64)
			...
			.saturating_add((143_552_000_u64).saturating_mul(n as Weight))
	...
	fn migrate_multiple_genesis_accounts_locking(n: u32, ) -> Weight {
		(79_825_000_u64)
			...
			.saturating_add((145_386_000_u64).saturating_mul(n as Weight))
