...
impl<T: frame_system::Config> pallet_web3_names::WeightInfo for WeightInfo<T> {
	...
	fn claim(n: u32, ) -> Weight {
		Weight::from_ref_time(58_514_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(20_000 as u64).saturating_mul(n as u64))
	...
	fn release_by_owner() -> Weight {
		Weight::from_ref_time(55_643_000 as u64)
	...
	fn reclaim_deposit(n: u32, ) -> Weight {
		Weight::from_ref_time(52_172_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(34_000 as u64).saturating_mul(n as u64))
	...
	// Storage: Web3Names Names (r:0 w:1)
	fn ban(n: u32, ) -> Weight {
		Weight::from_ref_time(56_687_000 as u64)
			// Standard Error: 1_000
			.saturating_add(Weight::from_ref_time(30_000 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(4 as u64))
	}
	// Storage: Web3Names Banned (r:1 w:1)
	fn unban(n: u32, ) -> Weight {
		Weight::from_ref_time(31_222_000 as u64)
			// Standard Error: 1_000
			.saturating_add(Weight::from_ref_time(35_000 as u64).saturating_mul(n as u64))
	...
	fn change_deposit_owner() -> Weight {
		Weight::from_ref_time(69_280_000 as u64)
			.saturating_add(T::DbWeight::get().reads(4 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: Web3Names Owner (r:1 w:1)
	...
	fn update_deposit() -> Weight {
		Weight::from_ref_time(60_735_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
