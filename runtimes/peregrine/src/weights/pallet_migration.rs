...
impl<T: frame_system::Config> pallet_migration::WeightInfo for WeightInfo<T> {
	...
	fn attestation_migration_weight() -> Weight {
		...
		//  Measured:  `846`
		//  Estimated: `4414`
		// Minimum execution time: 70_603_000 picoseconds.
		Weight::from_parts(71_645_000, 0)
	...
	fn did_migration_weight() -> Weight {
		...
		//  Measured:  `1002`
		//  Estimated: `5777`
		// Minimum execution time: 72_320_000 picoseconds.
		Weight::from_parts(72_952_000, 0)
	...
	fn public_credentials_migration_weight() -> Weight {
		...
		Weight::from_parts(23_364_000, 0)
			.saturating_add(Weight::from_parts(0, 3513))
			.saturating_add(T::DbWeight::get().reads(1))
	}
}
