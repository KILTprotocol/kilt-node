...
use frame_support::{
	...
	traits::{ConstU128, ConstU16, ConstU32, ConstU64, Currency, Everything},
};
...
use pallet_dip_provider::DefaultIdentityCommitmentGenerator;
