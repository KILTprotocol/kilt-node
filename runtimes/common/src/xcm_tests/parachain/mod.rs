...
use xcm_builder::{
	Account32Hash, AccountId32Aliases, AllowUnpaidExecutionFrom, EnsureXcmOrigin, FixedRateOfFungible,
	FixedWeightBounds, NativeAsset, ParentIsPreset, SiblingParachainConvertsVia, SignedAccountId32AsNative,
...
impl EnsureOriginWithArg<RuntimeOrigin, MultiLocation> for ForeignCreators {
	...
	fn try_origin(o: RuntimeOrigin, a: &MultiLocation) -> sp_std::result::Result<Self::Success, RuntimeOrigin> {
