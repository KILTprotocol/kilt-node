...
pub mod bonded_coins {
	...
	pub const ASSET_ID_BYTE_LENGTH: u32 = 16;
	/// https://github.com/paritytech/polkadot-sdk/blob/master/substrate/frame/assets/src/types.rs#L188
	pub const ASSET_METADATA_BYTE_LENGTH: u32 = 26;
	pub const DEPOSIT_PER_CURRENCY: Balance = deposit(1, ASSET_ID_BYTE_LENGTH + ASSET_METADATA_BYTE_LENGTH);
