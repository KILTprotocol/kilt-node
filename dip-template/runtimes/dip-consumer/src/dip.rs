...
use runtime_common::constants::dip_provider;
...
use {
	did::did_details::DidEncryptionKey, did::did_details::DidPublicKey, did::did_details::DidPublicKeyDetails,
	did::did_details::DidVerificationKey, kilt_dip_primitives::VersionedDipParachainStateProof,
	pallet_did_lookup::linkable_account::LinkableAccountId, pallet_web3_names::Web3NameOf, sp_core::H256, sp_std::vec,
};

#[cfg(feature = "runtime-benchmarks")]
pub struct ProviderRuntimeWorstCaseGenerator;

#[cfg(feature = "runtime-benchmarks")]
impl kilt_support::traits::GetWorstCase<kilt_support::benchmark::IdentityContext<DidIdentifier, AccountId>>
	for ProviderRuntimeWorstCaseGenerator
{
	type Output = VersionedDipParachainStateProof<
	...
	fn worst_case(_context: kilt_support::benchmark::IdentityContext<DidIdentifier, AccountId>) -> Self::Output {
		use hex_literal::hex;
		use kilt_dip_primitives::*;
		use pallet_relay_store::relay::RelayParentInfo;
		use sp_core::{ed25519, sr25519};

		let proof = kilt_dip_primitives::merkle::v0::ParachainDipDidProof {
			provider_head_proof: ProviderHeadStateProof {
				relay_block_number: 169,
				proof: vec![
		...
		frame_system::Pallet::<ProviderRuntime>::set_block_number(33);
		frame_system::BlockHash::<ProviderRuntime>::insert(
			0,
			H256::from(hex!("9776c2a6921124e360d8d444113d596077a7e9eab629458f8af8a92c54287577")),
		);
		pallet_relay_store::LatestRelayHeads::<Runtime>::insert(
			169,
			RelayParentInfo {
				relay_parent_storage_root: H256::from(hex!(
					"d9abcc76ff142acfb4bd44cc99fabd1f121b15df699b1c91bc1cf6e35afd48fe"
				)),
			},
		);

		VersionedDipParachainStateProof::V0(proof)
	}
}
...
impl pallet_dip_consumer::Config for Runtime {
	...
	#[cfg(feature = "runtime-benchmarks")]
	type ProofWorstCase = ProviderRuntimeWorstCaseGenerator;
}
