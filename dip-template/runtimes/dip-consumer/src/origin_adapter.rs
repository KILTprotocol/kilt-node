...
use crate::{AccountId, DidIdentifier, MerkleProofVerifierOutputOf, Runtime, RuntimeOrigin, Web3Name};
...
pub struct DipOriginAdapter(DipOrigin<DidIdentifier, AccountId, MerkleProofVerifierOutputOf<Runtime>>);
